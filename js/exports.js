...
export const cookieFun = () => {
    ...
    howToCenterDivInHtml.setAttribute("style", "background: #dddddd66; text-align:center; display: flex; justify-content: center; align-items: center; height: 100vh; width: 100vw; position: fixed; top: 0; left: 0; z-index: 100;");
 ...
 * @deprecated use byId
 */
export const byIdx = (id) => document.getElementById(id) || (() => { throw new Error("no element with id " + id); })();
// prettier-ignore
export const byId = (id) => (document.getElementById(id)) || (() => { throw new Error("no element with id " + id); })();
